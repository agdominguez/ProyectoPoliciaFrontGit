...
export class VinculacionPersonalSubcircuitoService {

  private urlEndPoint: string = 'http://localhost:8080/vinculacionPersonalSubcircuito'
  ...
  getListGlobal(pageSize: number, page: number): Observable<any> {
    ...
    return this.http.get<any>(url).pipe(
      ...
      tap((response: any) => {
        (response.content as VinculacionPersonalSubcircuito[]).forEach(vinculacionPersonalSubcircuito => {
        });
      })
    );
  }
  ...
  getElement(): Observable<VinculacionPersonalSubcircuito[]> {
    return this.http.get<VinculacionPersonalSubcircuito[]>(this.urlEndPoint).pipe(
      catchError(error => this.handleError(error))
    );
  }
  ...
  create(vinculacionPersonalSubcircuito: VinculacionPersonalSubcircuito): Observable<any> {
    console.log(this.urlEndPoint, vinculacionPersonalSubcircuito);
    return this.http.post<any>(this.urlEndPoint, vinculacionPersonalSubcircuito, { headers: this.httpHeaders }).pipe(
      catchError(error => this.handleError(error))
    );
  }
  ...
  update(vinculacionPersonalSubcircuito: VinculacionPersonalSubcircuito): Observable<VinculacionPersonalSubcircuito> {
    return this.http.put<any>(`${this.urlEndPoint}/${vinculacionPersonalSubcircuito.codigo}`, vinculacionPersonalSubcircuito, { headers: this.httpHeaders }).pipe(
      catchError(error => this.handleError(error)),
      map((response: any) => response.elemento as VinculacionPersonalSubcircuito)
    );
  }
  ...
  delete(id: any): Observable<VinculacionPersonalSubcircuito> {
    return this.http.delete<VinculacionPersonalSubcircuito>(`${this.urlEndPoint}/${id}`, { headers: this.httpHeaders }).pipe(
      catchError(error => this.handleError(error))
    );
  }
   ...
   */
  getElemtsform(): Observable<VinculacionPersonalSubcircuito[]> {
    return this.http.get<VinculacionPersonalSubcircuito[]>(this.urlEndPoint + '/list').pipe(
      catchError(error => this.handleError(error))
    );
  }
  /**
  ...
  getNotDeletedOrdered(pageSize: number, page: number, sortColumn: string, sortDirection: string): Observable<any> {
    ...
    return this.http.get<any>(url, { params }).pipe(
      catchError(error => this.handleError(error)),
      tap((response: any) => {
        (response.content as VinculacionPersonalSubcircuito[]).forEach(apertura => {
