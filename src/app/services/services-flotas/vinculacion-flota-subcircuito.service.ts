...
export class VinculacionFlotaSubcircuitoService {


  private urlEndPoint: string = 'http://localhost:8080/vinculacionFlotaSubcircuito'
  ...
  getListGlobal(pageSize: number, page: number): Observable<any> {
    ...
    return this.http.get<any>(url).pipe(
      ...
      tap((response: any) => {
        (response.content as VinculacionFlotaSubcircuito[]).forEach(vinculacionFlotaSubcircuito => {
        });
      })
    );
  }
  ...
  getElement(): Observable<VinculacionFlotaSubcircuito[]> {
    return this.http.get<VinculacionFlotaSubcircuito[]>(this.urlEndPoint).pipe(
      catchError(error => this.handleError(error))
    );
  }
  ...
  create(vinculacionFlotaSubcircuito: VinculacionFlotaSubcircuito): Observable<any> {
    console.log(this.urlEndPoint, vinculacionFlotaSubcircuito);
    return this.http.post<any>(this.urlEndPoint, vinculacionFlotaSubcircuito, { headers: this.httpHeaders }).pipe(
      catchError(error => this.handleError(error))
    );
  }
  ...
  update(vinculacionFlotaSubcircuito: VinculacionFlotaSubcircuito): Observable<VinculacionFlotaSubcircuito> {
    return this.http.put<any>(`${this.urlEndPoint}/${vinculacionFlotaSubcircuito.codigo}`, vinculacionFlotaSubcircuito, { headers: this.httpHeaders }).pipe(
      catchError(error => this.handleError(error)),
      map((response: any) => response.elemento as VinculacionFlotaSubcircuito)
    );
  }
  ...
  delete(id: any): Observable<VinculacionFlotaSubcircuito> {
    return this.http.delete<VinculacionFlotaSubcircuito>(`${this.urlEndPoint}/${id}`, { headers: this.httpHeaders }).pipe(
      catchError(error => this.handleError(error))
    );
  }
   ...
   */
  getElemtsform(): Observable<VinculacionFlotaSubcircuito[]> {
    return this.http.get<VinculacionFlotaSubcircuito[]>(this.urlEndPoint + '/list').pipe(
      catchError(error => this.handleError(error))
    );
  }
  /**
